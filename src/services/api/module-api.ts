import {addDoc, collection, deleteDoc, doc, getDocs, onSnapshot, orderBy, query, limit,updateDoc} from "firebase/firestore";
import {db} from "@/services/firebase-app.ts";

// get all modules
const get = async (limitItems?:number): Promise<TModule[]> => {
    let q = listQuery;
