...
import {Link as RouterLink, Outlet, useMatches, NavLink} from "react-router-dom";
import {UIMatch} from "@remix-run/router";
import {RouteHandle} from "../routs.tsx";
import ConfirmDialog, {ConfirmDialogProps} from "../components/ConfirmDialog.tsx";
import {useDialog} from "../hooks/use-dialog.ts";
import {AdminToolkitContext, AdminToolkitProvider} from "../components/admin/shared/AdminToolkitContext.tsx";
...
export default function Admin() {
    ...
    return (
        <Box sx={{display: 'flex'}}>
            ...
            <Box component="main"  sx={{flexGrow: 1, px: {xs: 5}, py:5, bgcolor: '#fff', minHeight: '100vh', display: 'flex'}}>
