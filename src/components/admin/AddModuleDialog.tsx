...
import type {TModule} from "@/services/api/module-api.ts";
...
const AddModuleDialog: React.FC<AddModuleDialogProps> = ({open,onClose, createModule })=> {
    ...
    return (
        ...
        >
            ...
            <DialogActions>
                <Button color='info'  variant='text' onClick={onClose}>Cancel</Button>
                <Button color='info'  variant='contained' onClick={onConfirmClick}>Add module</Button>
            </DialogActions>
        </Dialog>
    )
}
