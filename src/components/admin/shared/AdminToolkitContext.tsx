...
import {SettleState, useDialog} from "../../../hooks/use-dialog.ts";
import ConfirmDialog, {ConfirmDialogProps} from "../../ConfirmDialog.tsx";
import Snackbar from "@mui/material/Snackbar";
import {Alert} from "@mui/material";


export const AdminToolkitContext = createContext<TAdminToolkitContext>({showConfirmDialog: () => Promise.resolve('cancelled')})
