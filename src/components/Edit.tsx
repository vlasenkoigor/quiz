...
export const Edit: React.FC<EditorProps> = (props) => {
    ...
    return <>
        {showGallery &&
        <Dialog fullWidth={true} maxWidth={'md'} onClose={() => setShowGallery(false)} open={showGallery}><Gallery {...galleryProps}/></Dialog>}

        <ReactQuill readOnly={!!props.disabled} theme="snow" ref={quillRef} value={props.value}
                    onChange={props.setValue} onChangeSelection={setSelection}
